...
<!-- Mirrored from www.ahnlab.com/kr/site/login/findIdFinish.do by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2016 13:22:50 GMT -->
...
<!-- location -->
        ...
        <div class="contents">
            ...
            <div class="tabComm clfix">
                <ul>
                    <li class="on"><a href="findIdForm.html"><span class="hide">현재페이지</span>개인고객</a></li>
                    <li><a href="findIdBizForm.html">기업고객</a></li>
                </ul>
            </div>
            <!-- //tab -->

            <h1 class="hide">아이디 찾기 - 개인고객</h1>

            <p>회원님의 아이디 정보는 아래와 같습니다.</p>

            <!-- blue box -->
            <div class="boxTopInfo mt35">
                <div class="emResultWrap"><div class="boxCont">
                    <p class="rsTxt"><span class="tit">아이디 정보</span><span class="txt"></span></p>

                    <!-- 기업고객일 때 메시지 노출 -->
                    <!-- <p class="rsTxt"><span class="tit">담당자 정보</span><span class="txt">(회사명) 홍길동</span></p> -->
                    <!-- //기업고객일 때 메시지 노출 -->

                    <p class="tCenter">정보도용을 피하기 위해 아이디 끝 3자리는 ***표시하였습니다.</p>
                </div></div>
            </div>
            <!-- //blue box -->
            ...
            <!-- button -->
            <div class="btnCenter">
                <a href="findPwForm.html" class="btnCommon"><span class="btnTxt">비밀번호 찾기</span></a>
                <a href="loginForm.html" class="btnCommon darkBlue"><span class="btnTxt">로그인</span></a>
            </div>
            <!-- //button -->
