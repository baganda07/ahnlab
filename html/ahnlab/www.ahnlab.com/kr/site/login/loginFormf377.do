...
<!-- Mirrored from www.ahnlab.com/kr/site/login/loginForm.do?from_url=http%3A%2F%2Fwww.ahnlab.com%2Fkr%2Fsite%2Fsupport%2Fvirus%2FreportForm.do by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2016 13:14:58 GMT -->
        ...
        <div class="htopWrap">
            ...
            <nav id="naviUtill">
                <ul>
                    ...
                    <li><a href="loginForm.html" class="link">로그인</a></li>
                    
                    <li><a href="loginFormede2.html" class="link">MY보안센터</a></li>
                            ...
                            <div class="flRight">
                             <ul>
                                 ...
                                 <li>
                                     ...
                                     <!-- button -->
                                     <a href="loginFormc6a4.html" class="linkText"><span class="btnTxt">제품 확인 및 증서 출력</span><span class="btnIcon"></span></a>
                                 </li>
                             </ul>
                         </div>
                            ...
                            <div class="flRight">
                             <ul>
                                 ...
                                 <li>
                                     ...
                                     <a href="#" onclick='if(confirm("로그인 후 다운로드 가능합니다. \n로그인 페이지로 이동하시겠습니까?")){Common.login("../../../index.html","loginForm1a0c.html");}' class="linkText"><span class="btnTxt">내가 구매한 제품</span><span class="btnIcon"></span></a>
                                ...
                                <div class="naviWrap ">
                                     ...
                                     <p class="tit"><a href="../support/virus/virus.html">바이러스 신고센터</a></p>
                                       ...
                                       <ul class="thrList">
                                            ...
                                            <li><a href="loginFormd15e.html?tab=1">바이러스 신고</a></li>
                                       ...
                                       <ul class="thrList">
                                            ...
                                            <li><a href="loginFormd0a2.html?tab=error">오진 신고</a></li>
                                       ...
                                       <ul class="thrList">
                                            ...
                                            <li><a href="loginForm5653.html?tab=fake">가짜 백신 신고</a></li>
...
if (incTop_t==1 && incTop_c==1) {
    ...
    <div id="container">
        ...
        <div class="contents">
            ...
            <input type="hidden" name="from_url" id="from_url" value="http://www.ahnlab.com/kr/site/support/virus/reportForm.do" />
            <!-- login -->
            <div class="loginWrap">
                
                
                
                <p class="welcome"><img src="../../../../image.ahnlab.com/img_upload/kr/site/images2/login/logo_ahnlab.gif" alt="AhnLab"/>에 오신 것을 환영합니다.</p>
                
                
                <!-- login info -->
                <div class="boxLogin">
                    <p class="txt">아이디 / 비밀번호를 입력하세요.</p>
                    <input type="text" name="userId" id="userid" class="inputEm" value="" maxlength="16" title="아이디를 입력하세요" placeholder="아이디" onkeyup="javascript:if(event.keyCode == 13){ login(); }"/>
                    <input type="password" name="passwd" id="passwd" class="inputEm" value="" title="비밀번호를 입력하세요" placeholder="비밀번호" autocomplete="off" onkeyup="javascript:if(event.keyCode == 13){ login(); }"/>

                    <div class="button"><a href="#" class="btnEmBlue"><span class="btnTxt">로그인</span></a></div>

                    <div class="tRight">
                        <span>해킹차단기</span> <a href="#" class="linkTLine">OFF</a>
                    </div>
                </div>
                <!-- //login info -->
                ...
                <div class="etcLogin">
                    <div class="tabList">
                        <ul>
                            <li><a href="../customer/userEntry.html">회원가입</a></li>
                            <li><a href="findIdForm.html">아이디</a> / <a href="findPwForm.html">비밀번호</a> 찾기</li>
                            <li><a href="loginFormf20a.html">회원탈퇴</a></li>
							<li><a href="../etc/policy.html#cl07">개인정보 열람청구</a></li>
                        </ul>
                    </div>
                </div>
                <!-- //support login menu -->
                ...
                <ul class="txt_desc">
                    <li class="blGrayDot">비밀번호는 영문의 대/소문자를 구분합니다.</li>
                    <li class="blGrayDot">비밀번호 도용을 막기 위해 <span class="fcBlue">영문, 숫자, 특수문자</span>의 조합으로 이루어진 비밀번호를<br/>
                        만드는 것이 좋으며 정기적으로 비밀번호의 수정을 권합니다.</li>
                </ul>
            </div>
            <!-- //login -->
            </form>
        ...
        $(document).ready(function() {
	        ...
	        $(".linkTLine").click(function (){
	        	POPUP.open('popAosMain.html', 'popAosMain', {width: 600, height: 654});
	        });
