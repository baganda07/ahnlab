...
<!-- Mirrored from www.ahnlab.com/kr/site/customer/userEntryArticle.do?type=E&elsType=NM by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2016 13:14:09 GMT -->
...
<head>
	...
	<!-- 페이스북 -->
	<meta property="og:title"           content="AhnLab :: 안전해서 더욱 자유로운 세상"/>
	<meta property="og:description"     content=""/>

	<!-- 트위터 -->
	<meta name="twitter:title"          content="AhnLab :: 안전해서 더욱 자유로운 세상">
	<meta name="twitter:description"    content="">

    <!-- SEO -->
    <title>AhnLab :: 안전해서 더욱 자유로운 세상</title>
...
<input type="hidden" name="ctrcNo" id="ctrcNo" value=""/>
<input type="hidden" name="custCryptSeq" id="custCryptSeq" value="" />
<input type="hidden" name="elsType" id="elsType" value="NM" />
        <!-- 대타이틀 -->
        <div class="topTitWrap">
            <!-- title -->
            <h2 class="topTit">회원가입</h2>
            <!-- //title -->
        </div>
        <!-- //대타이틀 -->
        ...
        <div class="contents">
            <div class="stepComm">
                <ul class="type4 clfix">
                    <li class="on">
                        <span class="step"><span class="hide">현재단계</span>Step 1</span>
                        <p class="tit">이용약관 확인 및 동의</p>
                        <p class="desc">이용약관 및 개인정보 수집 및 이용 안내를 확인해 주세요</p>
                    </li>
                    <li>
                        <span class="step">Step 2</span>
                        <p class="tit">개인고객 본인인증<br/>기업고객 회사정보 확인</p>
                        <p class="desc">개인회원 본인인증, 기업회원 회사정보 확인<br/>으로 더욱 안전하게 이용하실 수 있습니다.</p>
                    </li>
                    <li>
                        <span class="step">Step 3</span>
                        <p class="tit">회원가입 정보입력</p>
                        <p class="desc">회원 가입에 꼭 필요한 고객님의<br/>정보를 알려주세요.</p>
                    </li>
                    <li>
                        <span class="step">Step 4</span>
                        <p class="tit">회원가입 완료</p>
                        <p class="desc">감사합니다.<br/>회원가입이 완료되었습니다.</p>
                    </li>
                </ul>
                <div class="contTitWrap">
                    <h1 class="contTit">01. 약관 확인 및 동의</h1>
                </div>
            </div>
            <div class="contTitWrap mt20">
                <h3 class="contTit"><span class="fcBlue">(필수)</span> 사이트 이용 약관</h3>
            </div>
            <div class="scrollWrap joinAgree">
                <div class="scroCont">
		            <div class="termsWrap">
				...
				<h3>[제 1장 총칙]</h3>
                <h4>제 1조 목적</h4>
                <p>이 약관은 AhnLab, Inc. (이하 회사 또는 AhnLab)이 제공하는 모든 서비스의 이용 조건 및 절차에 관한 사항과 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                <h4>제 2조 효력과 변경</h4>
                <ul class="blNum">
                ...
                <ul class="blNum">
                    <li>(1) 이용계약의 해지는 무료회원의 경우에는 언제나 가능하며, 제품고객으로 등록된 유료회원의 경우에는 자동 해지 처리 시 등록된 제품정보까지 삭제되어 제품 이용 관련 고객지원 서비스 제공에 문제가 발생할 수 있습니다. 따라서 자동 해지 처리가 불가하며 AhnLab의 고객지원센터를 통해 관련 해지 절차를 안내 받아 개별적으로 처리할 수 있습니다. 단, 이럴 경우 유료서비스 고객에게만 제공되는 인터넷상의 다양한 유료 서비스를 이용하실 수 없게 됩니다.</li>
                    ...
                    <li>(5) 회사는 회원의 개인정보 보호를 위하여 서비스 미사용자(최종 로그인한 후 법률에서 정한 기간 동안 로그인 기록이 없는 회원)에 대해 정기적으로 회원자격 상실에 대한 안내문(전자우편)을 통지하고, 안내문에서 정한 기한(30일) 내에 로그인이 없을 경우 회원자격을 상실시킬 수 있습니다. 이 경우, 회원 아이디를 포함한 회원의 개인정보 및 서비스 이용정보는 파기, 삭제됩니다.</li>
            ...
            <p class="mt10"><input type="checkbox" id="chkUseAgree" class="chk" name="check1" value="Y" /><label for="chkUseAgree">이용약관에 동의합니다.</label></p>

            <div class="contTitWrap mt25">
                <h3 class="contTit"><span class="fcBlue">(필수)</span> 개인정보의 수집 및 이용 안내</h3>
            </div>
			<div class="tabComm clfix">
                <ul>
                    <li class="on"><a href="#" class="tab_customer tab_view1"><span class="hide">현재페이지</span>수집하는 개인정보의 항목</a></li>
                    <li><a href="#" class="tab_customer tab_view2">개인정보의 수집 및 이용목적</a></li>
                    <li><a href="#" class="tab_customer tab_view3">개인정보의 보유 및 이용기간</a></li>
                </ul>
            </div>
            <!-- //tab -->

            <div class="indivInfo tab_cont1" style="display:block;">
                <h4 class="hide">수집하는 개인정보의 항목</h4>
                <div class="scrollWrap joinAgree">
                    <div class="scroCont">
                        <div class="termsWrap">
							<p>홈페이지의 회원가입 통해 아래와 같은 최소한의 개인정보를 수집하고 있습니다. 상담 및 문의(전화, 팩스, 홈페이지), 설문 및 이벤트 참여, 제휴사의 제공을 통해 아래 정보가 추가 수집될 수 있습니다.</p>
							<ul class="blDot mb15">
							<li><strong>공통 [필수항목]</strong> 이름, 아이디, 비밀번호, 비밀번호 힌트, 이메일, 휴대전화번호</li>
							<li><strong>개인 회원 [필수항목]</strong> 생년월일, 성별</li>
							<li><strong>기업 회원 [필수항목]</strong> 부서명</li>
							</ul>
							<p>회원이 제품 배송, 환불을 할 시 아래와 같은 최소한의 개인정보를 수집하고 있습니다.</p>
							<ul class="blDot mb15">
							<li><strong>배송 [필수항목]</strong> 수취인의 이름, 주소, 휴대전화번호</li>
            ...
            <div class="indivInfo tab_cont2" style="display:none;">
                <h4 class="hide">개인정보의 수집 및 이용목적</h4>
                <div class="scrollWrap joinAgree">
                    <div class="scroCont">
                       <div class="termsWrap">
							...
							<p>회원의 제품 구매 정보와 배송, 환불을 할 시 수집된 정보는 아래와 같이 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산에 이용 됩니다.</p>
							<ul class="blDot mb15">
							<li>공지사항 전달, 콘텐츠 제공, 불만 처리 등 의사소통 경로 확보, 구매 및 요금 결제, 물품배송 또는 청구서 등 발송, 금융거래 본인 인증 및 금융 서비스</li>
							</ul>
						</div>
                    </div>
                </div>
            ...
            <div class="indivInfo tab_cont3" style="display:none;">
                <h4 class="hide">개인정보의 보유 및 이용기간</h4>
                <div class="scrollWrap joinAgree">
                    <div class="scroCont">
                        <div class="termsWrap">
            ...
            <p class="mt10"><input type="checkbox" id="chkInfoAgree1" class="chk" name="check2" value="Y" /><label for="chkInfoAgree1">개인정보수집 및 이용에 동의합니다. (필수)</label></p>

			<div class="contTitWrap mt25">
                <h3 class="contTit"><span class="fcBlue">(선택)</span> 개인정보의 수집 및 이용 안내</h3>
            </div>
			<div class="tList01 mt20">
                <table>
                    <caption>개인정보의 수집 및 이용 안내 선택 상세 목록</caption>
                    <colgroup>
                        <col style="width:10%;" />
						<col style="width:10%;" />
                        <col style="width:40%;" />
                    ...
                    <tbody>
					<tr>
						<td class="first" rowspan="2">가입</td>
						<td>개인</td>
						<td>일반전화번호</td>
					...
					<tr>
						<td class="first" colspan="2">거래</td>
						<td>수취인의 일반 전화번호</td>
						<td>배송</td>
						<td>관계 법령의 규정 기간</td>
					</tr>
            ...
            <p class="mt10"><input type="checkbox" id="chkInfoAgree2" class="chk" name="check3" value="Y" /><label for="chkInfoAgree2">개인정보수집 및 이용에 동의합니다. (선택)</label></p>

            <!-- button -->
            <div class="btnCenter">
                <a href="userEntry.html" class="btnCommon"><span class="btnTxt">취소</span></a>
                <a href="#" class="btnCommon darkBlue btnEnter"><span class="btnTxt">확인</span></a>
            </div>
            <!-- //button -->
...
$(function() {
	$(".tab_customer").click(function(){
		if($(this).hasClass("tab_view1")){
			$(".tab_cont3").hide();
			$(".tab_cont2").hide();
			$(".tab_cont1").show();
			$(".tab_view3").parent().removeClass("on");
            $(".tab_view2").parent().removeClass("on");
            $(".tab_view1").parent().addClass("on");
		}
		if($(this).hasClass("tab_view2")){
            $(".tab_cont3").hide();
            $(".tab_cont1").hide();
            $(".tab_cont2").show();
            $(".tab_view3").parent().removeClass("on");
            $(".tab_view1").parent().removeClass("on");
            $(".tab_view2").parent().addClass("on");
        }
		if($(this).hasClass("tab_view3")){
            $(".tab_cont2").hide();
            $(".tab_cont1").hide();
            $(".tab_cont3").show();
            $(".tab_view2").parent().removeClass("on");
            $(".tab_view1").parent().removeClass("on");
            $(".tab_view3").parent().addClass("on");
        }
	});
    ...
    $(".btnEnter").click(function (){
        ...
        $("#customerForm").attr("action", "elsUserEntryCertifyForm.html");
...
<!-- Mirrored from www.ahnlab.com/kr/site/customer/userEntryArticle.do?type=E&elsType=NM by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2016 13:14:11 GMT -->
</html>
