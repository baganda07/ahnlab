...
<!-- Mirrored from www.ahnlab.com/kr/site/support/b2b/eduSales.do by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2016 13:13:48 GMT -->
...
<head>
    ...
    <!-- SEO -->
    <meta name="Keywords" content="연간 일정, 세일즈 교육, 라이선스 정책, 솔루션 정보, 세일즈 기술 지식" />
    <meta name="Description" content="&#034;세일즈 교육은 파트너 사 영업대표 및 마케팅 담당자들을 위한 교육으로, 안랩 제품을 판매하기 위한 라이선스 정책 및 솔루션 정보,  세일즈 기술 지식 등을 제공합니다.&#034;" />
	<!-- 페이스북 -->
	<meta property="og:title"           content="세일즈 교육 | AhnLab"/>
	<meta property="og:description"     content="&#034;세일즈 교육은 파트너 사 영업대표 및 마케팅 담당자들을 위한 교육으로, 안랩 제품을 판매하기 위한 라이선스 정책 및 솔루션 정보,  세일즈 기술 지식 등을 제공합니다.&#034;"/>

	<!-- 트위터 -->
	<meta name="twitter:title"          content="세일즈 교육 | AhnLab">
	<meta name="twitter:description"    content="&#034;세일즈 교육은 파트너 사 영업대표 및 마케팅 담당자들을 위한 교육으로, 안랩 제품을 판매하기 위한 라이선스 정책 및 솔루션 정보,  세일즈 기술 지식 등을 제공합니다.&#034;">

    <!-- SEO -->
    <title>세일즈 교육 | AhnLab</title>
...
<!-- location -->
        ...
        <div class="contents">
            ...
            <div class="tabSubMenu clfix">
                <ul>
                    ...
                    <li class="on"><a href="eduSales.do"><span class="hide">현재페이지</span>세일즈 교육</a></li>
                    <li><a href="eduTech.do">기술 교육</a></li>
            ...
            <div class="descCopy mt35">
                <p>세일즈 교육은 파트너 사 영업대표 및 마케팅 담당자들을 위한 교육으로, 안랩 제품을 판매하기 위한 라이선스 정책 및 솔루션 정보, <br />세일즈 기술 지식 등을 제공합니다.</p>
                <p class="mt10">전문적인 세일즈 교육을 받음으로써 파트너는 고객의 요구를 충족시키는 최적의 솔루션을 제안할 수 있습니다. <br />해당 교육을 통해 파트너 분들이 꼭 알아야 하는 세일즈 지식과 다양한 정보를 공유 받으시길 바랍니다.</p>
            </div>
            <!-- //서브카피 -->
            ...
            <div class="tList02">
                <table>
                    ...
                    <tbody>
                        <tr class="first">
                            <th scope="row">교육명</th>
                            <td>AhnLab Partner Step up Training for Sales</td>
                        </tr>
                        <tr>
                            <th scope="row">대상</th>
                            <td>파트너 사 영업대표 및 마케팅 담당자</td>
                        </tr>
                        <tr>
                            <th scope="row">장소</th>
                        ...
                        <tr>
                            <th scope="row">문의</th>
                            <td><a href="mailto:partner4u@ahnlab.com" class="linkTLine ls0">partner4u@ahnlab.com</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="eduSchedule noResult">
                예정된 교육이 없습니다.
            </div>
            ...
            <div class="scheduleList year">
                ...
                <div class="contTitWrap" id="eduFocusId">
                    ...
                    <div class="infoRight">
                        ...
                        <div class="tabList">
                            <ul>
                                <li class="on"><a href="eduSalese7d7.html?focus=t">연간 일정</a></li>
                                <li><a href="eduSalesMonthe7d7.html?focus=t">월간 일정</a></li>
                            </ul>
                        </div>
                        <!-- //tab list -->
                    </div>
        ...
        <!-- //contents -->
        <form method="post" name="techEduForm" id="techEduForm">
        <input type="hidden" name="eduDist" id="eduDist" value="P" />
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','.eduSalesDetail',function(){
            $(location).attr('href',"http://www.ahnlab.com/kr/site/support/b2b/eduSalesDetail.do?eduSeq="+$(this).attr('setvalue'));
        });

        $(document).on('click','.eduSalesReg',function(){
        	$(location).attr('href',"https://www.ahnlab.com/kr/site/support/b2b/eduSalesRegForm.do?eduSeq="+$(this).attr('setvalue')+"&preView=eduSales");
       });
        $("#eduSalesDetail").click(function(){
            $(location).attr('href',"http://www.ahnlab.com/kr/site/support/b2b/eduSalesDetail.do?eduSeq="+$(this).attr('setvalue'));
        });

        $("#eduSalesReg").click(function(){
        	$(location).attr('href',"https://www.ahnlab.com/kr/site/support/b2b/eduSalesRegForm.do?eduSeq="+$(this).attr('setvalue')+"&preView=eduSales");
       });

        $(document).on('click','#techEduMonth',function(){
        	$(location).attr('href',"techEduMonth.html");
       });
    ...
    function delGroupDetails(targetGubun){
        ...
        $.ajax({
            url: "https://www.ahnlab.com/kr/site/support/b2b/eduSalesAjax.do",
            dataType: 'json',
            data: {
                ...
                if (json.isSuccess) {
                    ...
                    if (data.result != null && 0 < data.result.length) {
	                    for(var i=0;i<data.result.length;i++){
	                        ...
	                        _htmltext+='</td>';
	                        _htmltext+='<td>';
	                        _htmltext+='<a href="#" class="btnSmall mr6 eduSalesDetail" title="TrusGuard 관리자교육 상세 내용 보기" setvalue="'+data.result[i].eduSeq+'">상세 내용 보기</a>';

	                        if(data.result[i].reg=='Y' && data.result[i].people=='Y'){
	                        _htmltext+='<a href="#" class="btnSmall blue eduSalesReg" title="TrusGuard 관리자교육 교육 참가 신청" setvalue="'+data.result[i].eduSeq+'">교육 참가 신청</a>';
	                        }else{
...
<!-- Mirrored from www.ahnlab.com/kr/site/support/b2b/eduSales.do by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2016 13:14:00 GMT -->
</html>
